...
urlpatterns = [
    ...
    path(
        "create_budget/",
        data_views.CreateKanriBudgetView.as_view(),
        name="create_budget",
    ),
    path(
        "create_shuuzen_budget/",
        data_views.CreateShuuzenBudgetView.as_view(),
        name="create_shuuzen_budget",
    ),
    path(
        "create_parking_budget/",
        data_views.CreateParkingBudgetView.as_view(),
        name="create_parking_budget",
    ),
    # データアップデート
    path(
        "budget_update_list/",
